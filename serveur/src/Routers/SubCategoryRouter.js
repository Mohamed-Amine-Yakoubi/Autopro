...
route.post(
  "/addSubCategory",
  upload.single("Image_subcat"),
  SubCategoryControllers.CreatesubCategory
);
route.get("/getSubcategory/:id_subcat", SubCategoryControllers.GetSubCategory);
route.get(
  "/getSubcategorybyidCat/:id_cat",
  SubCategoryControllers.GetSubCategoryByIdCat
);
route.get("/GetAllsubCategories", SubCategoryControllers.GetAllsubCategories);
route.delete("/DeleteSubcat", SubCategoryControllers.DeleteSubcat);
