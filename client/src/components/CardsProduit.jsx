...
const CardsProduit = ({ image, link,libelle, categorie, product,prix, stock,handleFavoris}) => {
...
<Link href={link}>
      ...
      {isHovered && (
        <div className="flex flex-col  ">
            ...
            <button onClick={() => handleAddToCart(product)} className="absolute top-2 right-3 bg-greenColor rounded-full h-6 w-6 flex justify-center items-center">
