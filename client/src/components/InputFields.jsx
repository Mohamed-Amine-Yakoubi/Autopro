...
const InputFields = ({
  ...
  if (type === "textarea") {
    return (
      <div className=" ">
        <textarea
          className="bg-grayColor rounded-2xl outline-none px-5 pt-2   "
          style={inputStyle}
          type={type}
    ...
    return (
      <div className=" ">
        <input
          className={`bg-grayColor rounded-full outline-none px-5 border-2 border-gray-300 text-[14px] pl-10`}
          style={inputStyle}
          type={type}
          name={name}
          placeholder={placeholder}
